 ...
 */
public class Test20 implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        String regex = "https://www\\.zhihu\\.com/people/";

        String url2 = url1.replaceAll(regex,"");

        System.out.println("nameOnLink：>>>>>>>>>"+url2);
    ...
    public static void main(String args[]) {
        String startUrl = "https://www.zhihu.com/people/xiang-xiao-wen-55";

        Spider.create(new Test20())
                .addUrl(startUrl)
